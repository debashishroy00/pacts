...
async def test_salesforce_create_contact():
    ...
    async with async_playwright() as p:
        ...
        # Step 7: FILL Email
        # Selector: input#input-366
        # Strategy: label_for, Confidence: 0.86
        await page.locator("input#input-366").fill("john.smith@example.com")
        # Step 8: FILL Phone
        # Selector: input#input-319
        # Strategy: label_for, Confidence: 0.86
        await page.locator("input#input-319").fill("555-0102")
        # Step 9: CLICK Save
